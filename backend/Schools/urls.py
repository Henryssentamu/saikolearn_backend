...
urlpatterns = [
	...
	path("student/schooldetails/", SchoolsDetailsForStudents.as_view(), name="create-list-school"),
	path("admin/coursedetails/",CourseDetails.as_view(), name="create-list-courses"),
	path("student/coursedetails/",CourseDetailsForStudent.as_view(), name="create-list-courses"),
