    ...
    <div>
      ...
      <div className="poppins-regular" style={{ margin: "135px 10px", padding: "20px", fontSize: "21px" }}>
        <div className="poppins-regular ">
          <h1 className="poppins-black m-2">Ssentamu Innovation Hub Of Science And Technology - SIST admission policy</h1>
        </div>

        <div>
          At Ssentamu Innovation Hub Of Science And Technology - SIST, we are dedicated to providing a transparent and equitable admission process to ensure every applicant has a fair
          ...
          Ssentamu Innovation Hub Of Science And Technology - SIST applicants throughout the admission process and as integral members of our vibrant community. It also elucidates the
          ...
          We believe in fostering a community that values diversity, equal opportunity, and inclusivity. The Ssentamu Innovation Hub Of Science And Technology - SIST admission process is
          ...
          <ul>
            ...
            <li>
              <span className="poppins-medium"> Respectful Conduct</span> Treat fellow applicants, Ssentamu Innovation Hub Of Science And Technology - SIST staff, and any involved
          ...
          Once accepted into the Ssentamu Innovation Hub Of Science And Technology - SIST community, members are expected to uphold the values of collaboration, innovation, and respect.
          ...
          Consequences for such behavior may include disqualification from the current application cycle or future cycles. Ssentamu Innovation Hub Of Science And Technology - SIST
          ...
          Ssentamu Innovation Hub Of Science And Technology - SIST is committed to enforcing fair and consistent measures to safeguard the well-being of all applicants. Our team
          diligently reviews each application, ensuring that decisions are made impartially and in alignment with our commitment to
          diversity and inclusion. By adhering to these guidelines, Ssentamu Innovation Hub Of Science And Technology - SIST aims to create an environment where every applicant can
          ...
          after the specified deadlines may not be considered, unless explicitly stated otherwise by Ssentamu Innovation Hub Of Science And Technology - SIST. If there is a compelling
          and unavoidable reason for a late submission, Ssentamu Innovation Hub Of Science And Technology - SIST will assess the circumstances. The acceptance or rejection of a late
          submission is solely at the discretion of Ssentamu Innovation Hub Of Science And Technology - SIST, contingent upon their review of the provided justification.
          ...
          <ul className="poppins-regular" style={{ fontSize: "21px" }}>
            <li>
              ...
              rigorous nature of our programs, Ssentamu Innovation Hub Of Science And Technology - SIST allows learners to be enrolled in only one program concurrently. If you have
            ...
            <li>
              ...
              following the one from which they were declined. However, Ssentamu Innovation Hub Of Science And Technology - SIST does not allow applicants to reapply within the same
            ...
            <li>
              <span className="poppins-medium">Application Fee:</span> Ssentamu Innovation Hub Of Science And Technology - SIST is dedicated to providing clarity and transparency in our
