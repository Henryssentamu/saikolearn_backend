...
export function SchoolOfSoftwareEngineering() {
    ...
    <div>
      ...
      <div className="container-fluid schoolOfSoftwareEngineering">
        <div className="banner-content ">
          <div className="poppins-black m-3" style={{ fontSize: "36px" }}>
            Welcome to school of Software Enginering!
          </div>
      ...
      <div className="row row-cols-1 row-cols-md-1 row-cols-lg-2 " style={{ marginTop: "130px", padding: "10px", gap: "120px" }}>
        ...
        <div className="col">
          <h1 className="poppins-black">THE SCHOOL OF SOFTWARE ENGINEERING</h1>
          <p className="poppins-regular" style={{ fontSize: "16px" }}>
            Welcome to the School of Software Engineering, where we provide a comprehensive array of technical courses meticulously crafted
            to empower learners with the essential knowledge and skills needed to launch their careers and excel on a global scale. Our
            diverse range of technical courses is designed to prepare you for the initiation, transition, or advancement in your tech
            career. With a focus on ensuring that students are fully equipped, we integrate dynamic self-paced learning, interactive live
            classes, and collaborative peer-to-peer training to offer an immersive educational experience.
          </p>
